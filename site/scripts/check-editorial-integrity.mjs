...
if (checkOrientation || checkRelease) {
  ...
  expect(report.documents === 66, `expected 66 published documents, found ${report.documents}`);
  expect(report.mainChapters === 44, `expected 44 main chapters, found ${report.mainChapters}`);
