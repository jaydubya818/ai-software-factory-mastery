...
import CompatiblePage, { metadata as compatibleMetadata } from "../guide/atlas/page";

export const metadata = GUIDE_COMPATIBLE_MODE ? compatibleMetadata : {};

export default async function LegacyVisualsPage({ searchParams }: { searchParams: Promise<GuideSearchParams> }) {
