...
const areas = [
  ...
  ["Agent Factory", "Capability identity, registries, packaging, dependency resolution, certification, promotion, and revocation.", "Review-ready architecture; unified production registry remains unproven.", "/docs/03-build/11-the-agent-factory"],
  ["Repository intelligence and workflows", "Onboarding, owner validation, instructions, architecture, dependencies, build, tests, data, readiness, and the workflow catalog.", "Catalog and contracts are review ready; only the first bounded workflow has partial evidence.", "/docs/03-build/26-autonomous-engineering-workflows"],
  ["Verification & delivery", "Testing, artifacts, CI/CD, migrations, compatibility, progressive release, rollback, and production outcomes.", "Architecture is review ready; the complete production path remains unproven.", "/docs/04-prove/32-cicd-progressive-delivery-and-production-verification"],
  ["Factory platform", "Portal, catalog, golden paths, scheduling, cost, fairness, resilience, disaster recovery, and operator experience.", "Architecture is review ready; fleet-scale and recovery proof remains unproven.", "/docs/05-operate/34-the-factory-as-a-platform"],
  ["Security & governance", "Agentic threats, policy, identity, secrets, privacy, provenance, licensing, and compliance.", "Core controls and review-ready additions exist; full adversarial evidence remains unproven.", "/docs/04-prove/33-security"],
  ["Control & operations", "Emergency control, decision rights, SLOs, cost, continuity, drift, triage, response, and verified closure.", "Review-ready contracts; exercised fleet-scale operating proof remains unproven.", "/docs/05-operate/36-resilience-incidents-and-the-control-tower"],
  ["Evaluation & learning", "Datasets, graders, uncertainty, experiments, optimization, regression control, and human promotion.", "Architecture is review ready; production optimization and rollback remain unproven.", "/docs/04-prove/29-evaluation-engineering"],
];
