...
const comparisons: Comparison[] = [
  ...
  },
  {
    ...
    distinction: "An Agent is the goal-directed worker. An Agent Harness is its bounded operating envelope: model and tool interfaces, context, working state, permissions, budgets, stopping, telemetry, and completion contracts. The Runtime hosts execution and the Control Plane owns authority. The Harness can report completion; neither the Agent nor Harness can accept its own result.",
    ...
    right: { name: "Harness", owns: "Operating controls, session state, budgets, tool mediation, stopping, and run capture.", boundary: "It does not own Runtime infrastructure, workflow coordination, business authority, or acceptance." },
    links: [
  ...
  {
    id: "loop-harness",
    label: "Agent Loop / Agent Harness",
    short: "The Loop governs iteration. The Harness governs the operating envelope around the worker.",
    distinction: "The Agent Loop loads state, selects, acts, observes, evaluates, replans, and stops. The Agent Harness binds the task contract, context, model and tool interfaces, permissions, budgets, telemetry, and local lifecycle controls. A Work Graph coordinates work across nodes; the Runtime hosts execution; the Control Plane owns enterprise authority.",
    left: { name: "Agent Loop", owns: "One worker’s next-action cycle, progress evaluation, replanning, and stopping behavior.", boundary: "It does not own workflow topology, infrastructure lifecycle, or enterprise authority." },
    right: { name: "Agent Harness", owns: "How one Agent may use models, context, tools, working state, resources, and external systems.", boundary: "It does not own the Work Graph, Runtime, Sandbox, Control Plane, or Factory." },
    links: [
      { label: "Canonical terminology", href: guideDocumentPath("appendix/execution-boundaries-and-terminology") },
      { label: "Harness engineering", href: guideDocumentPath("03-build/16-harness-engineering") },
    ],
  },
  {
    id: "planes",
