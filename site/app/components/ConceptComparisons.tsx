...
const comparisons: Comparison[] = [
  {
    ...
    links: [
      { label: "Factory boundaries", href: "/docs/00-overview/05-software-factory-stack-boundaries" },
      { label: "Agent Factory supply chain", href: "/docs/agent-factory/01-capability-supply-chain-and-registries" },
    ],
  },
  {
    id: "agent-harness",
    ...
    links: [
      { label: "Agent architecture", href: "/docs/06-ai-engineering/01-agent-architecture-mcp-tools-context-and-memory" },
      { label: "Coding harnesses", href: "/docs/05-runtime-architecture/08-coding-harnesses-adapters-and-agent-protocols" },
    ],
  },
  {
    id: "harnesses",
    ...
    links: [
      { label: "Stack boundaries", href: "/docs/00-overview/05-software-factory-stack-boundaries" },
      { label: "Harness adapters", href: "/docs/05-runtime-architecture/08-coding-harnesses-adapters-and-agent-protocols" },
    ],
  },
  {
    id: "planes",
    ...
    links: [{ label: "Control and execution planes", href: "/docs/05-runtime-architecture/01-control-plane-and-execution-plane" }],
  },
  {
    id: "assurance",
    ...
    links: [
      { label: "Evaluation engineering", href: "/docs/06-ai-engineering/04-evaluation-engineering-trace-replay-and-run-comparison" },
      { label: "Quality and evidence", href: "/docs/07-quality-engineering/01-quality-and-evidence-architecture" },
    ],
  },
  {
    id: "context-memory",
    ...
    links: [
      { label: "Agent context and memory", href: "/docs/06-ai-engineering/01-agent-architecture-mcp-tools-context-and-memory" },
      { label: "Knowledge and retrieval", href: "/docs/06-ai-engineering/08-knowledge-context-and-retrieval-pipeline-specification" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Quality certificates", href: "/docs/07-quality-engineering/04-quality-contract-and-certificate-technical-specification" },
    ],
  },
  {
    ...
    links: [
      { label: "Authority and emergency control", href: "/docs/08-security-and-governance/07-authority-autonomy-and-emergency-control" },
      { label: "Decision rights", href: "/docs/03-operating-model/06-enterprise-governance-operating-model-and-decision-rights" },
    ],
  },
];
