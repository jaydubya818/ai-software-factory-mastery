...
**Related chapters.** [27. Quality and evidence architecture](./27-quality-and-evidence-architecture.md) defines the evidence semantics this chapter builds on. [28. Testing strategy for agentic change](./28-testing-strategy-for-agentic-change.md) and [29. Evaluation engineering](./29-evaluation-engineering.md) supply the methods the contract references. [32. CI/CD, progressive delivery, and production verification](./32-cicd-progressive-delivery-and-production-verification.md) continues the proof past release. [33. Security](./33-security.md) covers provenance, attestation, and signing infrastructure. [7. Governance, policy, and risk-proportional approval](../02-design/07-governance-policy-and-risk-proportional-approval.md) explains who may waive and approve. [5. Authoritative records](../02-design/05-authoritative-records.md) defines the Mission, Plan, and WorkOrder records the contract is compiled from. Terms are in the [glossary](../appendix/glossary.md).
