...
- Lab: [Governed issue to validated pull request](../appendix/labs/01-governed-issue-to-validated-pull-request.md) — build the evidence chain for one criterion through failure, correction, fresh validation, and acceptance.
