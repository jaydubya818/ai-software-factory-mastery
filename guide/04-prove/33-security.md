...
# 33. Security: identity, secrets, threats, and supply chain
...
**Related chapters.** [7. Governance, policy, and risk-proportional approval](../02-design/07-governance-policy-and-risk-proportional-approval.md) defines the policy the control plane evaluates. [13. Control plane, orchestrator, and execution plane](../03-build/13-control-plane-orchestrator-and-execution-plane.md) and [14. Durable execution](../03-build/14-durable-execution.md) explain leases, manifests, and claims. [17. Development environments, sandboxes, and compute](../03-build/17-development-environments-sandboxes-and-compute.md) covers isolation options. [18. Agent architecture](../03-build/18-agent-architecture.md) and [19. Data, knowledge, semantic, and context engineering](../03-build/19-data-knowledge-and-semantic-engineering.md) cover MCP, tools, context, and memory. [31. Quality contracts, proof packages, and certificates](./31-quality-contracts-proof-packages-and-certificates.md) uses the evidence envelope and signing model. [32. CI/CD, progressive delivery, and production verification](./32-cicd-progressive-delivery-and-production-verification.md) covers builder hardening in the delivery path. [36. Resilience, incidents, and the control tower](../05-operate/36-resilience-incidents-and-the-control-tower.md) owns the incident frame. Terms are in the [glossary](../appendix/glossary.md).
