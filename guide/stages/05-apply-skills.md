...
This is a concise orientation brief. [Chapter 10](../03-build/10-the-agent-factory.md) owns the capability registry and lifecycle; [Chapter 18](../03-build/18-agent-and-loop-engineering.md) owns skill design inside loops. Next: [Stage 6 · Evaluate](./06-evaluate.md).
...
- [Chapter 15 — Agent architecture, tools, and MCP](../03-build/15-agent-architecture.md)
