...
This is a concise orientation brief. [Chapter 6](../02-design/06-intent-and-specification-engineering.md) owns specification and quality contracts; [Chapter 18](../03-build/18-agent-and-loop-engineering.md) owns decomposition and topology. Next: [Stage 3 · Define Agent](./03-define-agent.md).
