...
This is a concise orientation brief. [Chapter 14](../03-build/14-durable-execution.md) owns durable Attempts and recovery; [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md) owns the harness. Next: [Stage 5 · Apply Skills](./05-apply-skills.md).
