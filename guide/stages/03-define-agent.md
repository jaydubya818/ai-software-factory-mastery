...
- Labs: [Capability certification and revocation](../appendix/labs/03-capability-certification-and-revocation-lab.md); [Capstone architecture and executive defense](../appendix/labs/02-capstone-architecture-and-executive-defense.md) (replace the inner harness without changing acceptance authority); [External capability intake and recertification](../appendix/labs/13-external-capability-intake-and-recertification-lab.md).
