...
This is a concise orientation brief. [Chapter 11](../03-build/11-the-agent-factory.md) owns capability lifecycle; [Chapter 21](../03-build/21-models-and-capability-selection.md) owns model selection. Next: [Stage 4 · Execute through Harness](./04-execute-through-harness.md).
...
- [Chapter 21 — Models, routing, and capability selection](../03-build/21-models-and-capability-selection.md)
- [Chapter 23 — Agent and loop engineering](../03-build/23-agent-and-loop-engineering.md)
- [Chapter 33 — Security](../04-prove/33-security.md)
