...
- [Chapter 11, The Agent Factory](../03-build/11-the-agent-factory.md) for the registry, publication, certification, deprecation, and revocation of capabilities; [Chapter 21, Models: routing, profiles, and capability selection](../03-build/21-models-and-capability-selection.md) for adapters, the capability registry, routing, fallback, and token economics in depth; [Chapter 5, Authoritative records](../02-design/05-authoritative-records.md) for AgentBinding, ExecutionManifest, and Factory Configuration records.
- [Chapter 15, Coding harnesses and agent protocols](../03-build/15-coding-harnesses-and-agent-protocols.md) for what a harness manifest must carry per backend; [Chapter 23, Agent and loop engineering](../03-build/23-agent-and-loop-engineering.md) for single-agent versus multi-agent design and the producer/verifier pattern; [Chapter 33, Security](../04-prove/33-security.md) for identity, credentials, and data classification; [Chapter 34, The factory as a platform](../05-operate/34-the-factory-as-a-platform.md) for the contribution model and release clocks.
