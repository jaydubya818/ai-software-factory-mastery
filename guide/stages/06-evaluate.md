...
This is a concise orientation brief. [Chapter 21](../04-prove/21-quality-and-evidence-architecture.md) owns evidence architecture; [Chapter 23](../04-prove/23-evaluation-engineering.md) owns evaluation programs. Next: [Stage 7 · Improve](./07-improve.md).
...
- [Chapter 21 — Quality and evidence architecture](../04-prove/21-quality-and-evidence-architecture.md)
- [Chapter 22 — Testing strategy](../04-prove/22-testing-strategy-for-agentic-change.md)
- [Chapter 23 — Evaluation engineering](../04-prove/23-evaluation-engineering.md)
- [Chapter 24 — Quality contracts and proof packages](../04-prove/24-quality-contracts-proof-packages-and-certificates.md)
