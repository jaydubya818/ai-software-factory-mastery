...
This is a concise orientation brief. [Chapter 24](../04-prove/24-quality-contracts-proof-packages-and-certificates.md) owns the decision package; [Chapter 25](../04-prove/25-cicd-progressive-delivery-and-production-verification.md) owns delivery and production verification. The value stream then returns to [Stage 1 · Builder Intent](./01-builder-intent.md) through new production signals.
...
- [Chapter 30 — Control surfaces, event contracts, and storage](../05-operate/30-control-surfaces-event-contracts-and-storage.md)
