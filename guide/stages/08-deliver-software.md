...
- Labs: [Progressive delivery and rollback](../appendix/labs/06-progressive-delivery-and-rollback-lab.md); [Governed issue to validated pull request](../appendix/labs/01-governed-issue-to-validated-pull-request.md); [Authority containment and decision replay](../appendix/labs/10-authority-containment-and-decision-replay-lab.md).
