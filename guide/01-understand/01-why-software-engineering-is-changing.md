...
- Lab: [Capstone architecture and executive defense](../appendix/labs/02-capstone-architecture-and-executive-defense.md), which asks you to redraw the operating loop, define the three measures, and answer the probabilistic-agent objection without notes.
- Sources: Jay West, *AI Software Factory Mission* (long-term mission, future operating model, five things you are building); *AI Software Factory Interview Study Guide*, chapters 1–4 (core thesis, the waiting problem, the four problem statements, the sociotechnical framing); *Mission Control North Star* (business-hours/overnight model, the seven work states); "How to get to a software factory," AI Engineer SF interview and talk (autonomy, automation, quality; the moving bottleneck; the backlog goes away); IndyDevDan, "Software factories give leverage on your prompt."
