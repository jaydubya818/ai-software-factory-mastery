...
infographics: [tech-stack-five-layers, maturity-model, adoption-path, build-vs-buy, gravity-well, contribution-model, release-clocks, deployment-topologies, usage-layers]
---
