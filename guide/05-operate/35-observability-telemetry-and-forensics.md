...
# 35. Observability, telemetry, and forensics
...
- [Chapter 13, Control plane, orchestrator, and execution plane](../03-build/13-control-plane-orchestrator-and-execution-plane.md) for the two planes being instrumented.
- [Chapter 14, Durable execution](../03-build/14-durable-execution.md) for leases, heartbeats, and idempotency keys that telemetry must carry.
- [Chapter 25, The 12-layer production AI agent stack](../03-build/25-the-12-layer-production-ai-agent-stack.md) for the Harness Engineering capture layer.
- [Chapter 27](../04-prove/27-quality-and-evidence-architecture.md) and [Chapter 31](../04-prove/31-quality-contracts-proof-packages-and-certificates.md) for how observations become evidence receipts.
- [Chapter 29, Evaluation engineering](../04-prove/29-evaluation-engineering.md) for replay, trajectory diff, and baseline-versus-candidate comparison.
- [Chapter 34, The factory as a platform](./34-the-factory-as-a-platform.md) for the cost ledger's allocation rule and reporting modes.
- [Chapter 36, Resilience, incidents, and the control tower](./36-resilience-incidents-and-the-control-tower.md) for what the control tower does with these signals.
...
- [Chapter 21, Models: routing, profiles, and capability selection](../03-build/21-models-and-capability-selection.md) for the routing decisions the routing trace records; [Chapter 39, Production feedback, automated review, and the agentic merge queue](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md) for structured findings as they are aggregated at review.
