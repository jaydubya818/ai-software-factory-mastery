...
It began as Jay West's own notes. Jay is an engineering leader with a quality-engineering background who built **Mission Control**, a control plane for human-directed, agent-executed software delivery. The guide is his attempt to write down, once and in order, everything he learned building it and everything the wider field has learned in parallel. It is also written for anyone else with the same problem: engineers who will build a factory, architects who must draw its boundaries, and executives who must decide whether to fund one and how to hold it accountable. The chapters do not talk down to any of these readers. They explain each idea in plain English first and then give it its precise name.
