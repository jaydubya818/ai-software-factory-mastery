...
Read: [Stage 4 · Execute through Harness](../stages/04-execute-through-harness.md) and [Chapter 19](../03-build/19-data-knowledge-and-semantic-engineering.md), with [Chapter 18](../03-build/18-agent-architecture.md) for how the loop consumes it.
...
Read: [Stage 4 · Execute through Harness](../stages/04-execute-through-harness.md) and [Chapter 19](../03-build/19-data-knowledge-and-semantic-engineering.md), with [Chapter 18](../03-build/18-agent-architecture.md) for memory types.
...
Read: [Stage 1 · Builder Intent](../stages/01-builder-intent.md) and [Chapter 19](../03-build/19-data-knowledge-and-semantic-engineering.md), with [Chapter 5](../02-design/05-authoritative-records.md) for the record hierarchy these words describe.
...
Read: [Stage 6 · Evaluate](../stages/06-evaluate.md), [Chapter 29](../04-prove/29-evaluation-engineering.md) for evaluation foundations, and [Chapter 30](../04-prove/30-evals-as-factory-assets.md) for replay, drift, and lifecycle operations.
...
Read: [Stage 4 · Execute through Harness](../stages/04-execute-through-harness.md) and [Chapter 17](../03-build/17-development-environments-sandboxes-and-compute.md).
...
Read: [Stage 4 · Execute through Harness](../stages/04-execute-through-harness.md) and [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md), with [Chapter 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md) for the vendor landscape.
...
Read: [Stage 7 · Improve](../stages/07-improve.md) and [Chapter 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md).
...
Read: [Stage 8 · Deliver Software](../stages/08-deliver-software.md) and [Chapter 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md).
...
Read: [Stage 2 · Plan](../stages/02-plan.md) and [Chapter 10](../02-design/10-multi-repository-design.md).
...
Read: [Stage 4 · Execute through Harness](../stages/04-execute-through-harness.md) and [Chapter 14](../03-build/14-durable-execution.md), with [Chapter 36](../05-operate/36-resilience-incidents-and-the-control-tower.md) for incidents and the control tower.
...
This area describes how humans sit relative to the loop, in it, on it, or out of it, and how the corrections they make stop being repeated. Compounding engineering is the mechanism: a correction made twice becomes an evaluated repository instruction, a skill, a test, or a workflow rule, so the third occurrence never reaches a human. [Chapter 41](../06-improve/41-meta-loops-and-the-closed-loop-factory.md) owns that promotion path.

Read: [Stage 7 · Improve](../stages/07-improve.md) and [Chapter 40](../06-improve/40-governed-learning.md), with [Chapter 8](../02-design/08-economics-metrics-and-human-attention.md) for attention economics and [Chapter 4](../02-design/04-the-human-agent-operating-model.md) for the operating model.
...
Read: [Stage 3 · Define Agent](../stages/03-define-agent.md) and [Chapter 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md).
...
Read: [Chapter 44](../06-improve/44-where-this-is-going.md), with [Stage 1 · Builder Intent](../stages/01-builder-intent.md) for prototype-as-specification.
...
Capability areas are what a factory has to be able to do; the table ranks them. P0 areas are the ones without which the factory is not a factory; P1 areas are what make it survivable and economical; P2 areas are what make it acceptable to a regulated enterprise. The Skills Framework and the eight factory workflows that the source material describes are now first-class: the framework lives in [Stage 5](../stages/05-apply-skills.md) and [Chapter 12](../03-build/12-skills-as-packages.md), and the workflow catalog in [Chapter 26](../03-build/26-autonomous-engineering-workflows.md).

| Priority | Area | What the guide covers | Where |
|---|---|---|---|
| P0 | Agent Factory capability supply chain | Creating, packaging, versioning, evaluating, publishing, admitting, deprecating, and revoking agents, skills, tools, and model profiles; the Skills Framework and skill maturity | [Ch. 11](../03-build/11-the-agent-factory.md), [Ch. 12](../03-build/12-skills-as-packages.md), [Stage 5](../stages/05-apply-skills.md) |
| P0 | Capability registries | Agent, skill, tool, prompt, and evaluator registries; capability packages, certification, and revocation | [Ch. 11](../03-build/11-the-agent-factory.md) |
| P0 | Repository onboarding and intelligence | Repository readiness records, codebase intelligence, onboarding gates, and what a repository must expose before an agent may work in it | [Ch. 26](../03-build/26-autonomous-engineering-workflows.md) |
| P0 | Autonomous engineering workflow catalog | The governed inventory of supported workflows, including the eight factory workflows, their contracts, and their autonomy ceilings | [Ch. 26](../03-build/26-autonomous-engineering-workflows.md) |
| P0 | Software testing engineering | Test strategy for agentic change: unit through end-to-end, contract, mutation, property-based, fuzz, performance, accessibility, and visual regression; flaky-test handling and test-impact analysis | [Ch. 28](../04-prove/28-testing-strategy-for-agentic-change.md) |
| P0 | Complete delivery lifecycle | CI/CD, artifact registries, progressive delivery, production verification, rollback, and the measured outcome | [Ch. 32](../04-prove/32-cicd-progressive-delivery-and-production-verification.md), [Stage 8](../stages/08-deliver-software.md) |
| P1 | Factory scheduling and economics | Schedulers, admission control, capacity reservation, cost per accepted outcome, attention budgets, and leverage | [Ch. 34](../05-operate/34-the-factory-as-a-platform.md), [Ch. 8](../02-design/08-economics-metrics-and-human-attention.md) |
| P1 | Factory resilience | Durable execution, leases, reconciliation, incidents, disaster recovery, and the control tower | [Ch. 36](../05-operate/36-resilience-incidents-and-the-control-tower.md), [Ch. 14](../03-build/14-durable-execution.md) |
| P1 | Agentic security threat model | Indirect prompt injection, tool and memory poisoning, denial of wallet, workload identity, delegated authorization, supply chain, and SBOMs | [Ch. 33](../04-prove/33-security.md) |
| P1 | Evaluation science | Datasets, trials, graders, calibration, significance, trace replay, and run comparison | [Ch. 29](../04-prove/29-evaluation-engineering.md), [Ch. 30](../04-prove/30-evals-as-factory-assets.md) |
| P1 | Human-agent experience | Builder surfaces, plan previews, review inboxes, decision packets, and the ergonomics of human authority | [Ch. 37](../05-operate/37-control-surfaces-event-contracts-and-storage.md), [Ch. 7](../02-design/07-governance-policy-and-risk-proportional-approval.md) |
| P1 | Platform product model | The factory as an internal product: golden paths, developer portals, service catalogs, adoption, and the infrastructure landscape | [Ch. 34](../05-operate/34-the-factory-as-a-platform.md), [Ch. 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md) |
| P2 | Data, privacy, legal, compliance | Retention, residency, license compliance, policy as code, and the evidence regulators ask for | [Ch. 33](../04-prove/33-security.md), [Ch. 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md) |
| P2 | Workflow and event contracts | Workflow contracts, event schemas, trace context, storage of immutable history, and control-surface APIs | [Ch. 37](../05-operate/37-control-surfaces-event-contracts-and-storage.md), [Ch. 13](../03-build/13-control-plane-orchestrator-and-execution-plane.md) |
...
1. **Stack boundaries.** The runtime, agent, harness, factory, environment, compute, and workflow definitions above did not exist as a set; now they do, in [Chapter 2](../01-understand/02-the-factory-in-one-view.md), [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md), and the [glossary](../appendix/glossary.md).
2. **Data, knowledge, context, and semantic engineering.** Four disciplines that were one paragraph now have explicit boundaries: source preparation and meaning in [Chapter 19](../03-build/19-data-knowledge-and-semantic-engineering.md), and per-attempt compilation in [Chapter 20](../03-build/20-context-engineering.md).
3. **Evaluation datasets, graders, replay, and comparison.** Evaluation foundations live in [Chapter 29](../04-prove/29-evaluation-engineering.md); replay, drift, and operated eval assets live in [Chapter 30](../04-prove/30-evals-as-factory-assets.md).
4. **Development environments, compute fleets, and composable infrastructure.** The environment contract, the compute that hosts it, and the build-versus-buy decision are in [Chapter 17](../03-build/17-development-environments-sandboxes-and-compute.md).
5. **Inner and outer harnesses, adapters, and protocols.** Protocol boundaries live in [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md); session, adapter, and conformance engineering live in [Chapter 16](../03-build/16-harness-engineering.md).
6. **Orchestration, routing, convergence, and escalation loops.** Durable orchestration is in [Chapter 13](../03-build/13-control-plane-orchestrator-and-execution-plane.md), model routing in [Chapter 22](../03-build/22-routing-and-the-escalation-ladder.md), and convergence and stop behavior in [Chapter 24](../03-build/24-loop-engineering-patterns-and-defaults.md).
7. **Production feedback, reproduction, review, and merge.** The feedback-to-reproduction flow, automated review, and the agentic merge queue are in [Chapter 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md).
8. **Multi-repository coordination.** Coordinated change sets, workspace manifests, and the submodule, subtree, and symlink failure modes are in [Chapter 10](../02-design/10-multi-repository-design.md).
9. **Compounding engineering and human-attention economics.** Governed signals begin in [Chapter 40](../06-improve/40-governed-learning.md), correction harvesting and promotion continue in [Chapter 41](../06-improve/41-meta-loops-and-the-closed-loop-factory.md), and attention is budgeted in [Chapter 8](../02-design/08-economics-metrics-and-human-attention.md).
...
**Loop, graph, harness, meta-harness.** The four nested layers of an agent system, with the diagnosis rule that most agent failures are architecture failures at a specific layer, not prompting failures, are in [Chapter 18](../03-build/18-agent-architecture.md), with the loop's completion rule in [Chapter 24](../03-build/24-loop-engineering-patterns-and-defaults.md) and the meta-harness boundary in [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md). The six-layer implementation view is mapped row by row in Chapter 18.

**The economics of running a factory at scale.** Tokenomics, budgets, and factory ROI are in [Chapter 9](../02-design/09-tokenomics-and-factory-economics.md); benchmark-driven routing is in [Chapter 22](../03-build/22-routing-and-the-escalation-ladder.md); the tool gateway and code-mode are in Chapter 18; loop defaults that decide cost are in [Chapter 24](../03-build/24-loop-engineering-patterns-and-defaults.md); the context graph is in [Chapter 19](../03-build/19-data-knowledge-and-semantic-engineering.md); the move from interactive sessions to managed agents is in [Chapter 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md); and governed skill improvement is in [Chapter 41](../06-improve/41-meta-loops-and-the-closed-loop-factory.md). The public figures cited are one organization's published measurements and are labelled as such.

**The capability supply chain, as tooling now practises it.** Skills as versioned packages, the skill inventory, and scored quality gates are in [Chapter 12](../03-build/12-skills-as-packages.md); with-and-without eval operations are in [Chapter 30](../04-prove/30-evals-as-factory-assets.md); install policy is in [Chapter 33](../04-prove/33-security.md); review history enters through [Chapter 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md); and durable correction harvesting is in [Chapter 41](../06-improve/41-meta-loops-and-the-closed-loop-factory.md).

**Mission Control at its current revision.** The seven operating principles, the eleven-stage gate table, the eight-actor ownership table, the inequality chain from execution to production verification, the proof record, and the current limitations are in [Chapter 42](../06-improve/42-mission-control-as-a-living-case-study.md), pinned to the commit named there.

**Review at scale.** The ten-mechanism design for automated review across a large, mixed estate — repository profiling, incremental indexing, change classification, risk-tiered depth, hierarchical context, specialised reviewers, evaluation by repository or workload class, budget-aware escalation, structured findings with evidence, and global/product/repository policy layers — is in [Chapter 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md).

**The agentic security architecture.** The seven-layer security map — agent and workload identity, policy and access control, the runtime security control plane, threat prevention and detection, response and containment, the infrastructure and data foundation, and visibility and telemetry — with its five cross-cutting flows, its zero-trust principles, and the three things a security map cannot show (the evidence boundary, the authority record, kill switch versus recovery), is in [Chapter 33](../04-prove/33-security.md).

**The tech stack and the leader's vocabulary.** The five-layer enterprise agentic AI tech stack — capabilities per layer, representative 2026 products, and the chapter that owns each — is in [Chapter 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md), with the two things vendor maps omit (the control plane and the Agent Factory) called out. The twenty terms leaders are most often handed — agentic AI, supervised autonomy, escalation design, agent identity, audit trail, governance agent, scope boundary, consent fatigue, guardrails, hallucination, tool calling, reasoning effort, ontological bias, agent lifecycle, multi-agent system, and the rest — are all in the [glossary](../appendix/glossary.md), each defined by the responsibility it owns and what it does not prove.
...
| # | Must cover | Chapters |
|---|---|---|
| 1 | Factory architecture, operating models, economics, and adoption | [Ch. 2](../01-understand/02-the-factory-in-one-view.md), [Ch. 4](../02-design/04-the-human-agent-operating-model.md), [Ch. 8](../02-design/08-economics-metrics-and-human-attention.md), [Ch. 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md) |
...
| 3 | AI coding agents, agent orchestration, workflows, and loop engineering | [Ch. 13](../03-build/13-control-plane-orchestrator-and-execution-plane.md), [Ch. 18](../03-build/18-agent-architecture.md), [Ch. 23](../03-build/23-agent-and-loop-engineering.md), [Ch. 26](../03-build/26-autonomous-engineering-workflows.md) |
| 4 | Coding harnesses, adapters, lifecycle hooks, MCP, ACP, AG-UI, and A2A | [Ch. 15](../03-build/15-coding-harnesses-and-agent-protocols.md) |
| 5 | Data, knowledge, semantic, context, and model engineering | [Ch. 19](../03-build/19-data-knowledge-and-semantic-engineering.md), [Ch. 21](../03-build/21-models-and-capability-selection.md) |
| 6 | Development environments, compute fleets, sandboxes, and composable infrastructure | [Ch. 17](../03-build/17-development-environments-sandboxes-and-compute.md) |
| 7 | Evaluation datasets, trials, graders, trace replay, and run comparison | [Ch. 29](../04-prove/29-evaluation-engineering.md), [Ch. 30](../04-prove/30-evals-as-factory-assets.md) |
| 8 | Independent verification, proof packages, provenance, and quality gates | [Ch. 27](../04-prove/27-quality-and-evidence-architecture.md), [Ch. 31](../04-prove/31-quality-contracts-proof-packages-and-certificates.md) |
| 9 | Production feedback, reproduction, automated review, and merge maintenance | [Ch. 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md) |
| 10 | Multi-repository delivery, dependency coordination, submodules, and subtrees | [Ch. 10](../02-design/10-multi-repository-design.md) |
| 11 | Security, identity, policy, progressive autonomy, and human decision rights | [Ch. 3](../01-understand/03-first-principles-trust-evidence-and-authority.md), [Ch. 7](../02-design/07-governance-policy-and-risk-proportional-approval.md), [Ch. 33](../04-prove/33-security.md) |
| 12 | Compounding engineering, controlled improvement, and human-attention economics | [Ch. 8](../02-design/08-economics-metrics-and-human-attention.md), [Ch. 40](../06-improve/40-governed-learning.md), [Ch. 41](../06-improve/41-meta-loops-and-the-closed-loop-factory.md) |
...
1. **Stack boundaries and the Agent Factory.** Start with the definitions, then the factory that supplies the parts: [Chapter 2](../01-understand/02-the-factory-in-one-view.md), [Chapter 11](../03-build/11-the-agent-factory.md), [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md).
2. **Data, knowledge, context, and semantic engineering.** What the agent may know and how the attempt receives it: [Chapter 19](../03-build/19-data-knowledge-and-semantic-engineering.md), [Chapter 20](../03-build/20-context-engineering.md), with [Chapter 18](../03-build/18-agent-architecture.md) beside them.
3. **Evaluation, replay, and comparison.** How you know any of it works: [Chapter 29](../04-prove/29-evaluation-engineering.md), [Chapter 30](../04-prove/30-evals-as-factory-assets.md), and [Stage 6](../stages/06-evaluate.md).
4. **Environments, compute, and build-versus-buy.** Where the work runs and what you should own: [Chapter 17](../03-build/17-development-environments-sandboxes-and-compute.md).
5. **Feedback, reproduction, review, and merge.** What happens after the first release: [Chapter 39](../06-improve/39-production-feedback-review-and-the-agentic-merge-queue.md) and [Stage 7](../stages/07-improve.md).
6. **Multi-repository delivery and protocols.** The coordination problems that appear at scale: [Chapter 10](../02-design/10-multi-repository-design.md), then the protocol sections of [Chapter 15](../03-build/15-coding-harnesses-and-agent-protocols.md).
7. **The enterprise and open-source landscape.** What to buy, what to build, and what to keep replaceable: [Chapter 38](../05-operate/38-enterprise-adoption-and-the-infrastructure-landscape.md) and [Chapter 34](../05-operate/34-the-factory-as-a-platform.md).
8. **Prototype and extensible-software patterns.** The adjacent material for what comes next: [Chapter 44](../06-improve/44-where-this-is-going.md) and the prototype-as-specification passage in [Stage 1](../stages/01-builder-intent.md).
