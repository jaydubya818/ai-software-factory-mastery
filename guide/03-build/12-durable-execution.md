...
6. Add multidimensional budgets and the stop conditions from [Chapter 11](./11-control-plane-orchestrator-and-execution-plane.md).
...
- Previous: [Chapter 11, Control plane, orchestrator, and execution plane](./11-control-plane-orchestrator-and-execution-plane.md) for the state machine, stop-condition table, and error taxonomy this chapter operationalizes.
