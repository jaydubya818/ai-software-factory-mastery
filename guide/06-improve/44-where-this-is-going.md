...
and [Chapter 17](../03-build/17-development-environments-sandboxes-and-compute.md):
...
in [Chapter 39](./39-production-feedback-review-and-the-agentic-merge-queue.md)).
...
itself, then sliced into reviewed PRs as in Chapter 39. An **interaction mock**
...
recognized field. Read against [Chapter 43](./43-mastering-the-factory.md),
...
- [Chapter 2 — The factory in one view](../01-understand/02-the-factory-in-one-view.md)
  and [Chapter 17 — Development environments, sandboxes, and compute](../03-build/17-development-environments-sandboxes-and-compute.md)
...
- [Chapter 39 — Production feedback, review, and the agentic merge queue](./39-production-feedback-review-and-the-agentic-merge-queue.md)
...
- [Chapter 42 — Mission Control as a living case study](./42-mission-control-as-a-living-case-study.md)
  and [Chapter 43 — Mastering the factory](./43-mastering-the-factory.md).
